<template>
  <ul class="mo-paging">
    ...
    <li :class="['paging-item', {'paging-item--current' : index === pager}]" v-for="(pager, index) in pagers" @click="go(pager)" :key="index">{{ pager }}</li>
...
<script>
export default {
  // https://segmentfault.com/a/1190000008606958  参考文章
  name: 'MoPaging',
